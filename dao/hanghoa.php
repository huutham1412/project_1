...
function hang_hoa_insert($ten_hh, $don_gia, $giam_gia, $hinh, $ngay_nhap, $mo_ta, $dac_biet, $so_luot_xem, $ma_loai){
    ...
    pdo_execute($sql, $ten_hh, $don_gia, $giam_gia, $hinh, $ngay_nhap, $mo_ta, $dac_biet==5, $so_luot_xem, $ma_loai);
}
...
function hang_hoa_update($ma_hh, $ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet, $so_luot_xem, $ngay_nhap, $mo_ta){
    ...
    pdo_execute($sql, $ten_hh, $don_gia, $giam_gia, $hinh, $ma_loai, $dac_biet==5, $so_luot_xem, $ngay_nhap, $mo_ta, $ma_hh);
}
...
function hang_hoa_cung_loai($ma_loai){
    $sql = "SELECT * FROM hang_hoa WHERE ma_loai = ? ORDER BY RAND() LIMIT 4";
...
function hang_hoa_select_dac_biet(){
    $sql = "SELECT * FROM hang_hoa WHERE dac_biet=5";
    return pdo_query($sql);
}
